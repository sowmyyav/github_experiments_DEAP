...
model2.summary()
# fit network
history=model2.fit(x_bvp_train, y_bvp_train_resampled, epochs=500, batch_size=256,callbacks = [es,mc], verbose=1,validation_data=(x_bvp_test, y_bvp_test_resampled))
